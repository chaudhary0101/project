...
const Dashboard = () => {
  ...
  const colors = ["#3B82F6", "#F87171", "#C084FC", "#EAB308", "#F59E0B"];
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          <button
            ...
            className="w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-solid border-slate-300 group hover:border-dashed hover:border-indigo-400 hover:shadow-md transition-all duration-300 cursor-pointer"
          >
          ...
          <button
            ...
            className="w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-solid border-slate-300 group hover:border-dashed hover:border-purple-400 hover:shadow-md transition-all duration-300 cursor-pointer"
          >
        ...
        {showCreateResume && (
          ...
          >
            <div
              onClick={(e) => e.stopPropagation()}
              className="relative bg-slate-50 border shadow-mb rounded-lg w-full max-w-sm p-6"
            >
