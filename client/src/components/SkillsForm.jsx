    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-200"
          value={newSkill}
      ...
      <div className="bg-blue-50 p-3 rounded-lg">
        <p className="text-sm text-blue-800">
          ...
          skills (programming, tools) and soft skills (leadership,
          communication).
        </p>
      </div>
    </div>
